...
HD_PWD='C:/Users/Administrator/Desktop/division/division.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log division.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source division.tcl -notrace
